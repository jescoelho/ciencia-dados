...
![Regressão Linear — minimizando os resíduos](assets/regressao_linear_intuicao.png)
...
![Retas candidatas e posição no espaço de custo](assets/ols_superficie_ssr.png)
...
![Geometria de β̂₀ e β̂₁](assets/coeficientes_geometria.png)
...
![Diagnóstico de linearidade](assets/premissas_linearidade.png)
...
![Diagnóstico de homocedasticidade](assets/premissas_homocedasticidade.png)
...
![Independência dos resíduos — série temporal e ACF](assets/premissas_independencia.png)
...
![QQ-plot dos resíduos — normalidade](assets/premissas_normalidade.png)
...
![Hiperplano ajustado com dois preditores](assets/hiperplano.png)
...
![Efeito total vs efeito parcial](assets/efeito_parcial.png)
...
![Scatter matrix dos preditores](assets/premissas_multicolinearidade.png)
...
![Regressão linear vs. logística em target binário](assets/logistica_intuicao.png)
...
![Efeito de β₁ e β₀ na curva logística](assets/sigmoid_parametros.png)
...
![Matriz de confusão e curva ROC](assets/logistica_avaliacao.png)
...
![Linearidade dos log-odds — diagnóstico por bins](assets/premissas_logodds_linearidade.png)
...
![Separação perfeita — sigmoide degenerando e dados separáveis](assets/premissas_separacao_perfeita.png)
